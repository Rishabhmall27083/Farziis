                    ...
                    {user ? (
                      <>
                        ...
                        <StyledTableCell align="right">
                          <Link
                            to={{
                              pathname: `/erpdashboard/student/updatealldetails/${user._id}`,
                              state: { userData }, // Pass the userData to the target component
                            }}
                          >
                            {/* <Link
                            to={user.randomId === <AdminStdtSearch/>
                              ? {
                                pathname: "/erpdashboard/student/updatealldetails",
                                state: { userData },
                              }
                              : user.randomId === <AdminDocumentSearch/>
                                ? "/erpdashboard/student/updatedocuments"  // Change this to the actual path
                                : ""
                            }
                          > */}
