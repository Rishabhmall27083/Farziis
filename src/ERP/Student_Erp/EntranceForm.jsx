     ...
     <Navbarcontanct/>
      <Container
        ...
        style={{
          ...
          margin: "50px auto",
          opacity: 0,
          transform: "translateX(-100%)", // Start position: move to the left
          transition: "opacity 0.5s ease-in-out, transform 0.5s ease-in-out", // Apply transition for opacity and transform
          animation: "slideInFromLeft 0.5s ease-in-out forwards" // Apply the slideInFromLeft animation
        }}
      ><style>{`
