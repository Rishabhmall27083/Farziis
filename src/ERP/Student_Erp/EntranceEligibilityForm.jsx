...
const EntranceEligibilityForm = ({ eligible, eligibilityGradPer, courseType, courseName}) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
     ...
     // console.log(enteredCategory, "category")
      ...
      if (IsEligible) {
         const response = await axios.post('https://sssutms.ac.in/apitest/v2/entrancedetails', {
          name: data.name,
          mobile: data.mobile,
          email: data.email,
              ...
              <div className="col-xl-12">
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    ...
                    <div className="row gx-3 mb-3">
                      <div className="col-md-3">
                        {/* <button className="btn btn" style={{ backgroundColor: "gray", color: "white" }} >Cancel</button> */}

                        <button className="btn btn" type="submit" style={{ backgroundColor: "#598392", color: "white", marginLeft: "15px" }}> Submit </button>
                      </div>
                    </div>
                  </div>
                </div>
