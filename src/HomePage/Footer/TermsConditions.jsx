...
<style>
 ...
 `
  ...
  {/* <header style={{marginTop:'none'}} >
    <nav>

      <img
        src="https://i.ibb.co/d7Ywndh/emblem-light-bg.jpg"
        alt="logo"
        className="logo"
      />

  
        <h1 style={{marginLeft:'800px',color:'white',fontSize:'40px',fontFamily:'fantasy'}}>TERMS & CONDITIONS</h1>
    </nav>
  </header> */}
  <main>
